...
fileprivate let WRDefaultTitleSize:CGFloat = 16
...
class WRCustomNavigationBar: UIView
{
    ...
    var textAlignment:NSTextAlignment? {
        willSet {
            titleLabel.textAlignment = newValue ?? .center
        }
    }
    var titletextColor:UIColor? {
        willSet {
            titleLabel.textColor = newValue ?? .white
        }
    }
    ...
    fileprivate lazy var titleLabel:UILabel = {
        ...
        label.font = UIFont.boldSystemFont(ofSize: WRDefaultTitleSize)
    ...
    fileprivate static var isIphoneX:Bool {
        get {
            return NAVIGATION_H > 64
        }
    }
    fileprivate static var navBarBottom:Int {
        get {
            return Int(NAVIGATION_H)
        }
    }
    
    // init
    class func CustomNavigationBar() -> WRCustomNavigationBar {
        let frame = CGRect(x: 0, y: 0, width: WRScreenWidth, height: CGFloat(NAVIGATION_H))
    ...
    func updateFrame()
    {
        ...
        let leftbuttonWidth:CGFloat = 44
        let buttonWidth:CGFloat = 80
        let titleLabelHeight:CGFloat = 44
        let titleLabelWidth:CGFloat = WSCREEN * 0.65
        
        backgroundView.frame = self.bounds
        backgroundImageView.frame = self.bounds
        leftButton.frame = CGRect(x: leftmargin, y: top, width: leftbuttonWidth, height: buttonHeight)
        rightButton.frame = CGRect(x: WRScreenWidth-buttonWidth-margin-8, y: top, width: buttonWidth, height: buttonHeight)
...
extension WRCustomNavigationBar
{
    ...
    private func wr_setRightButton(normal:UIImage?, highlighted:UIImage?, title:String?, titleColor:UIColor?) {
        ...
        rightButton.titleLabel?.font = UIFont.boldSystemFont(ofSize: 13)
    }
}
